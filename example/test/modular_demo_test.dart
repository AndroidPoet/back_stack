...
void main() {
  testWidgets(
    'modular demo: entries build screens, decorator wraps + tears down',
    (tester) async {
      ...
      expect(
        find.textContaining('decorator active on: Dashboard'),
        findsOneWidget,
      );
      ...
      expect(
        find.textContaining('decorator active on: Article #1'),
        findsOneWidget,
      );
